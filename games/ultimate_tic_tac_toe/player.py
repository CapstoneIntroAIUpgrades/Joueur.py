...
class Player(GameObject):
    """The class representing the Player in the UltimateTicTacToe game.
    ...
    @property
    def piece(self) -> str:
        """'x' or 'o': The color (side) of this player. Either 'x' or 'o', with the 'X' player having the first move.
        """
        return self._piece
