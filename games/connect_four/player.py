...
class Player(GameObject):
    """The class representing the Player in the ConnectFour game.
    ...
    @property
    def color(self) -> str:
        """'r' or 'y': The color (side) of this player. Either 'red' or 'yellow', with the 'red' player having the first move.
        """
        return self._color
